...
public:
	...
	int realHit(raytraceData::ray* r, raytraceData::sphere* s1, raytraceData::sphere* s2, raytraceData::sphere* s3, raytraceData::cylinder* cy1, raytraceData::cylinder* cy2, raytraceData::plane* pl, raytraceData::rec* rc);
