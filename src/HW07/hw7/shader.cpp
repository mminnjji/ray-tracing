...
material *shader::makeMaterial(GLfloat r, GLfloat g, GLfloat b, GLfloat amb, GLfloat diff, GLfloat spec, GLfloat shininess, GLfloat reflectivity, GLfloat refractive_index, GLfloat transparency)
{
    material *m;
...
// is Shadow confirm
int shader::isShadow(light l, point p)
{
    point po;
    vector n;
    material *m;
